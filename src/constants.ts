...
export const PATH_SRC = path.join(PATH_ROOT, 'dist');
export const PATH_ASSETS = path.join(PATH_ROOT, 'assets');
export const PATH_KEEP_ALIVE = path.join(PATH_SRC, 'keepAlive.js');
